      ...
      el.div(
        ...
        el.ul(
          ...
          el.li(
            ...
            el.a(
              {
                href: "index-1.htm"/*tpa=http://www.btcbot.pw/FAQ*/,
                target: '_blank'
              },
              'FAQ ',
...
if (currentBet > worldStore.state.user.balance){
currentBet = baseSatoshi
    ...
    { "from": wincondition, "to": Math.pow(2,32), "value": 0 }
  ],
      };
        ...
        el.div(
          ...
          el.div(
            ...
            el.div(
			 ...
			 el.div(
              {className: 'col-xs-6'},
              React.createElement(ActualMultiplier, null)
            ),
        ...
        el.tbody(
          ...
          worldStore.state.bets.toArray().map(function(bet) {
            return el.tr(
              ...
              el.td(
                null,
                ((bet.outcome)/Math.pow(2,32)*100).toFixed(2) + ' ',
                bet.meta.isFair ?
                  el.span(
  ...
  render: function() {
    ...
    return el.tr(
      ...
      el.td(
        ...
        (bet.profit/bet.wager).toFixed(2)
      ),
      // // Roll
      // el.td(
      //   null,
